...
public:
    Button(Vector2 position, Vector2 sizeOfButton /* In the sheet (texture) */, std::string text, std::shared_ptr<Texture2D> texture, std::shared_ptr<Font> font, std::function<void()> onClick);
